 ...
 */
public class RMILinkedHashSetStringElementWrapper implements RMIWrapper {
	 ...
	 */
	public RMILinkedHashSetStringElementWrapper() {
	}
	 ...
	 *            The iterable.
	 */
	public RMILinkedHashSetStringElementWrapper(Iterable<?> iterable) {
	 ...
	 *            The iterator.
	 */
	public RMILinkedHashSetStringElementWrapper(Iterator<?> iterator) {

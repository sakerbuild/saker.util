 ...
 */
public class RMIHashSetWrapper implements RMIWrapper {
	 ...
	 *            The iterable.
	 */
	public RMIHashSetWrapper(Iterable<?> iterable) {
	 ...
	 *            The iterator.
	 */
	public RMIHashSetWrapper(Iterator<?> iterator) {

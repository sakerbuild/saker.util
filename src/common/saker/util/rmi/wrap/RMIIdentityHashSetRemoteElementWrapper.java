 ...
 * @see ObjectUtils#newIdentityHashSet()
 */
public class RMIIdentityHashSetRemoteElementWrapper implements RMIWrapper {
	 ...
	 */
	public RMIIdentityHashSetRemoteElementWrapper() {
	}
	 ...
	 *            The iterable.
	 */
	public RMIIdentityHashSetRemoteElementWrapper(Iterable<?> iterable) {
	 ...
	 *            The iterator.
	 */
	public RMIIdentityHashSetRemoteElementWrapper(Iterator<?> iterator) {
	...
	public void readWrapped(RMIObjectInput in) throws IOException, ClassNotFoundException {
		...
		Set<Object> l = ObjectUtils.newIdentityHashSet();
		do {

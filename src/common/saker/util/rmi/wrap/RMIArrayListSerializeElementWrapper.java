 ...
 */
public class RMIArrayListSerializeElementWrapper implements RMIWrapper {
	 ...
	 */
	public RMIArrayListSerializeElementWrapper() {
	}
	 ...
	 *            The iterable.
	 */
	public RMIArrayListSerializeElementWrapper(Iterable<?> iterable) {
	 ...
	 *            The iterator.
	 */
	public RMIArrayListSerializeElementWrapper(Iterator<?> iterator) {
